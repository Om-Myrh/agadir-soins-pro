//#region node_modules/.nitro/vite/services/ssr/assets/content-C7eB-5lN.js
var PHONE_DISPLAY_FR = "06 66 06 43 69";
var PHONE_DISPLAY_INTL = "+212 6 66 06 43 69";
var PHONE_TEL = "tel:+212666064369";
var WHATSAPP = "https://wa.me/212666064369";
var EMAIL = "alaouihanane2233@gmail.com";
var content = {
	fr: {
		dir: "ltr",
		htmlLang: "fr",
		...
		hero: {
			...
			tagline: "Plus de 40 ans d'expérience au service de votre santé. Soins infirmiers à domicile, à Agadir et dans un rayon de 30 km, 7j/7, y compris les urgences.",
			...
			stats: [
				...
				{
					value: "7j/7",
					label: "week-ends et jours fériés"
				},
				{
					value: "30 km",
					label: "autour d'Agadir"
				}
			],
		...
		availability: {
			...
			items: [
				{
					title: "7j/7",
					text: "Du lundi au dimanche, week-ends et jours fériés inclus."
				},
				{
		...
		seo: {
			...
			description: "Infirmière libérale à Agadir et 30 km alentour : injections, pansements, prises de sang, perfusions, soins aux personnes âgées. 40 ans d'expérience, 7j/7, urgences."
		}
	},
	ar: {
		dir: "rtl",
		...
		hero: {
			...
			tagline: "أزيد من 40 سنة من الخبرة في خدمة صحتكم. خدمات تمريضية بالمنزل، في أكادير وفي دائرة 30 كيلومترًا، طيلة أيام الأسبوع، بما في ذلك الحالات المستعجلة.",
			call: "اتصلوا الآن",
			...
			stats: [
				...
				{
					value: "7/7",
					label: "بما في ذلك العطل والأعياد"
				},
				{
					value: "30 كلم",
					label: "حول أكادير"
		...
		availability: {
			...
			items: [
				{
					title: "7 أيام في الأسبوع",
					text: "من الاثنين إلى الأحد، بما في ذلك العطل والأعياد."
				},
				{
					title: "الحالات المستعجلة ليلاً",
					text: "إمكانية التدخل الليلي حسب التوفر."
				},
				{
					title: "مدة الوصول",
		...
		seo: {
			...
			description: "ممرضة حرة بأكادير وفي دائرة 30 كلم: الحقن، التضميد، تحاليل الدم، التسريب، رعاية المسنين. أزيد من 40 سنة خبرة، طيلة الأسبوع، مع الحالات المستعجلة."
		}
	}
};
//#endregion
export { WHATSAPP as a, PHONE_TEL as i, PHONE_DISPLAY_FR as n, content as o, PHONE_DISPLAY_INTL as r, EMAIL as t };
